...
.SYNOPSIS
    PowerShell script to identify a client's public IPv4 address.

.PARAMETER $UseIpv4Address
    Use this switch if DNS resolution is not available.

.PARAMETER $UseIpv6Address
    Use this switch if DNS resolution is not available.
...
.EXAMPLE
    Get-PublicIPAddress -UseIpv4Address
...
.EXAMPLE
    Get-PublicIPAddress -UseIpv6Address
...
Function Get-PublicIPAddress {
    ...
    Param (
        ...
        [Alias('IPv4')]
        [switch]$UseIpv4Address,
        [Alias('IPv6')]
        [switch]$UseIpv6Address,
        [switch]$Detailed

    )

    # // If DNS is not available attempt to use IP address to connect to ipconfig.io
    If ($UseIpv4Address) {

        # // Collect public IP address information
        Write-Verbose 'Collecting public address information from ipconfig.io using IPv4 address...'
        $Content = (Invoke-WebRequest -Method Get -Uri 'http://172.67.199.187/json' -Headers @{Host = 'ipconfig.io' } -UseBasicParsing)

    }

    ElseIf ($UseIpv6Address) {

        # // Collect public IP address information
        Write-Verbose 'Collecting public address information from ipconfig.io using IPv6 address...'
        $Content = (Invoke-WebRequest -Method Get -Uri 'http://[2606:4700:3035::6815:2a21]/json' -Headers @{Host = 'ipconfig.io' } -UseBasicParsing)
    ...
    Else {
        ...
        # // Collect public address information
        Write-Verbose 'Collecting public address information from ipconfig.io...'
        $Content = (Invoke-WebRequest -Method Get -Uri 'http://ipconfig.io/json' -UseBasicParsing)

    }

    $Content = $Content | ConvertFrom-Json

    Write-Output $Content.Ip

    If ($Detailed) {

        Write-Output $Content.City
        Write-Output $Content.Country
        Write-Output $Content.Hostname
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU/zRaI6mcciS3FnXTUxwVi1iI
# QoiggiDHMIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# DQEJBDEWBBQYOXGfkhvxi0gAJ0ivFEObuesr2jANBgkqhkiG9w0BAQEFAASCAYDY
# u0BRazb/52z2uFXuJxu1h+LhVGJidrzvY1L/4m8iwids8gISz0rTDqfnzhr62E3K
# T5EPHT+Xv+tRnrmbpuaqURRpkqEPbmAMrhbu0j/cy4HflypMnxJM7xjhex6nXBNY
# 2MzO6IFcU2T9vnbSm8OCrpOr1yvbSldzMzHsdEhHUjLnBC8U9vzVynBw5bR5NNPj
# ch6cf/5Kk5CL5MH1BzsCxVdPq8CpiUTDUcz+2y+mR0YSOvGMniYxOopb5B7+AKe8
# /QVOGpVJTt3K1yFAlG6Z/gP4usgj40UhTbfDYYIdI2fo2th9Oa5vursrScaskppL
# 7ssbRBqWzU8CPzovHNZcgGm6w8Q03Qmi1UwIS+K173EyMxbJf6tv7lKuxlMIozCL
# 4zm8l2yrl+jLI2bW+5XoaicCKHbLJ0KzneINtaDifFeuifrx8JM4a7aofEF9BmxX
# VtdhzQjK/DzWYfl7vZKLnWe5Q3RIFma4sxLqaufcIuna1hlYto22C1lJQ+fhUFOh
...
# ATAcBgkqhkiG9w0BCQUxDxcNMjIwODE1MjE0OTE0WjAvBgkqhkiG9w0BCQQxIgQg
# ixpCryVCXcwIuM1ZHeVImo3nlMYglgaErHwEB5xZyq8wDQYJKoZIhvcNAQEBBQAE
# ggIAZSaAZjDNEHQJGVuovJO+WAUyz7fIO0HyVmXGN2qamHxpGVoU1MwCl80ZIDDQ
# idYv/+NXHDVcoBXSobyHE9dd8JFr6W3FgU5RvcTL9GMpujiv0UaHOBiq6+YCPP30
# OrSa9XLnutfZb5DuvcrzYKOexTmN4qESU7f2+FBBZ5c84XTCvJ5vh6aleWWg5QiV
# IlSmMc9vvJAl2c+JYjHELuDwcccsimvz4y4fsfEQ9DRD8N3b/V4jWzGLmuuWoIAB
# dhcR77Z++GGtzFoj+mHaLCYlnslNP8lH0bZ3i40njFli3ahNnaptTkB2WsriOg0H
# hxWAg/ea6B233rEMhIb+HNYsrvYDqn6bujMkeBOOmZZU9vG4NX8ae0/zZR55k9eX
# UG+0V4e0iqfZT6NBR8sOnBwCuHuT2G+o1zId+vdn9nz1YwF9STj1ylzft3XpNEEK
# eQuj/Enytyd7UDXaxwJLmhUWwmhexkTwMr6guIJ/UXseUDckPKy4go0dkgPSNvBx
# xAOCJ03qXtq/lTT6eaFVm7+k9xae4gC9MREFbD4EO1bfpwTqlPwQvCnr4LG1lF5d
# gL4mG+4yOBF9kMEQ9NDDCJ/saTD8ktbhDNCXDWQaHLcNGElfjbtn8oF4Y1TQwSB9
# X2MYyoKs7kM5HXWat3jEGmBA8ntc6zvcxE1Ms4ML1JJwkXU=
