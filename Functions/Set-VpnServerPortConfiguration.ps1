...
.SYNOPSIS
    Configure SSTP and IKEv2 VPN ports on a Windows Server Routing and Remote Access Service (RRAS) server.
...
.EXAMPLE
    Set-VpnPortConfiguration -SstpPorts 2000 -Ikev2Ports 2000
...
.LINK
    https://github.com/richardhicks/aovpntools/blob/main/Functions/Set-VpnServerPortConfiguration.ps1
...
Function Set-VpnServerPortConfiguration {
    ...
    If ($PSCmdlet.ShouldProcess("$env:computername")) {
        ...
        If ($Restart) {
            ...
            Restart-Service -Name RasMan -Force -PassThru
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUNCusTgsskboyHvOKIqGznHB+
# C9KggiDDMIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# MRYEFF1d6BLue5NgxZv93HP4a5VzoGiTMA0GCSqGSIb3DQEBAQUABIIBgE19RktV
# E4FvG8KzTcCauP7lKNYG5rSyaDR5U9ukHlTIVh/mS0bXWOg6YN/B6HZcUHmpr+qG
# mwBghF8Xuk+ZOIHSAQXPJb4gFDEQ38xy2RmR0Eop6/DwvFxnbQk0+0bBRQaellS7
# ZsHERloaCD8INOh1imaEAhuqJ2eiGtzZqv6iyjhWwrGAkcdq6su1qyFH6gNdh+2Q
# NRmG1YENIWLOTakdtnL96/qKc3GEBFS4eWdRZ8MI4Hpp8wSXyvHG0i27uQIKfrgi
# fGLkJhLtHt1/p/wF3YjFnHWuRbWlsNwzPZVVujxOy+IBdwn3vjxHlKVrNOBGbs9Z
# fpNf1hRkL19jlVBSCPhLCaJDlxN+hzlp/tVJ7XwRuJTeKZE4JL3xSiQoKZgVC4xi
# S0ZSHWwOKbZnMG/d1Fdfhle2wBVFKYRllGMC3VF0iiyojvJwtWdP2dm4dgrNd554
# mje/VHXWS6WtuLe7XdNFS/OEe2WWzTXPpJ1EzzlG5vTprCJx3V5Pv0fIpaGCAyAw
...
# CSqGSIb3DQEJBTEPFw0yNDA0MTMxNzUzMDBaMC8GCSqGSIb3DQEJBDEiBCDnBAS4
# X5hZjJkCuSrl1YN4sKI8ZOWsWytRE/ag5dTfUjANBgkqhkiG9w0BAQEFAASCAgBL
# 5R9HgXK8TElYdpnYjuSMXd6MZZAiiVbsi3lv006zXJMeAZd4lo3AtSIKiKg+Dp0S
# 4+ILKYX0v0XbkyRdNi+n88f2mJYzy+Y/DpBfEX+ec5cG6RtHG0zr+CMVUE5VdsiQ
# wM3PBLuFGDUTuDrtDdNmWculeMyRP06ubKEsSejg7/xxCGo1yyaLmxHLOMi0DU+P
# aLLouIgDTxoTkdl8b2EZl1q3nuhXFIzOFhdIrBObJIDyIqNOwOjRjUVY4P1w6sm4
# CBRO3SQMX6zkTx9wZDFrdpTzfc+bZyQ4obEv+pV5EPgseTWGU0M0/9ppRbgUEGVx
# 6AhsSS8GnRJtJPXTqkysHyxkHeVEZSuiWzr9bV7S1QP3OXxkK+itrM+obZOZ1WeO
# qLE3lgrlVl7z2UJ8/eo0ENs9o8jzBTevqnPy+lGrPx5QW9IQJXaZpByJqkrO5HH2
# ej/W/FFStkKjwtEL0sRSxZZzoTh85jXtXs4v4aLOjb+YpI5xwQTqy5HPiaAd8kQC
# GaZg+DV5RmKMAqwVYZ26JEwAqi1DW+7A0EYZZEJO9+aLiYSkjwit+9L5MeImVq6X
# HF0+xP13uVHQJjvf1msH+f+0IeNqHsZOx4ap9S1phZGdHvyQSaPbDkqyTo9Sehfc
# XyhjY3ATHk+D0B/KJ2SDWn1JwAAaiVkC4Y7bO9gojA==
