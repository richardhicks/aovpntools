...
.EXAMPLE
    Set-VpnServerPortConfiguration -SstpPorts 2000 -Ikev2Ports 2000

    Running this PowerShell command will configure 2000 SSTP and IKEv2 ports. The RasMan and RemoteAccess services will not be restarted. The changes will not take effect until the services are restarted or the server is rebooted.

.EXAMPLE
    Set-VpnServerPortConfiguration -SstpPorts 1500 -Ikev2Ports 1500 -Restart

    Running this PowerShell command will configure 1500 SSTP and IKEv2 ports. The RasMan and RemoteAccess services will be restarted to apply the changes.

.EXAMPLE
    Set-VpnServerPortConfiguration -Ikev2Ports 1000 -SstpPorts 0 -Restart

    Running this PowerShell command will configure 1000 IKEv2 ports and disable SSTP ports. The RasMan and RemoteAccess services will be restarted to apply the changes.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBdmpxz12aE/ArO
# CIN9oOKLTWJnCToy5SGvPRaVUCXq9aCCH6YwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDmHsFqCQfA04rgmpMRv+V4
# 21hhipR91jQt5dOe+9Y0nzALBgcqhkjOPQIBBQAERzBFAiEA+QfkL5eBC/JqHK/x
# EIHtqAnW6sVxmjzRNWegGF4Y/PgCIHzNnvdFvtKlUv4i4nCCRnHPCxdwE6w8xdpT
# fxphGe6DoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMPAgEBMH0waTELMAkGA1UE
# BhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEwPwYDVQQDEzhEaWdpQ2Vy
# dCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2IFNIQTI1NiAyMDI1IENB
# MQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEFAKBpMBgGCSqGSIb3DQEJ
# AzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI2MDcwNzE5MDA1MlowLwYJ
# KoZIhvcNAQkEMSIEIMgm6NfNPbHgKk6SsyJ7vj8RlH8BttRuSzAsU8q9nN6TMA0G
# CSqGSIb3DQEBAQUABIICAB7pxMFz++coRDcCvN7TLV5vrxBzNOVCdBFIApmUXq4p
# /wo+4rIalwAxAfAchNf9jNaSYrg4oXAdufSibvax+eYGX87HxeeUBtGvjd68EW7I
# FccbPtQgDTHFYvUas1RP5ZEfBa2Vz3S78yyzJQLst74r0MEXMjQ594tQcCOJWQ0T
# MOZx63fSCdfBFTxgRAT8FK94zp8IjSJ3nBNRCuyCF/6wFYzO5jt8i3kdk9qTr/TS
# SDgO80pC+S5cUTbbKqMn4Fq3otKfGsJsdCcgaIiTMEyCKM+4XtVqyyyGQVtA7FDB
# sYWnIyZZiN1kf7thvJ5U4tKtg3lGjDgZvdmxQD+6yB5/mJ16ppMnJHK1lxYJiW2o
# 68NmtB+FKpzDmi7YUPM5pE9+GTZRGqX5wmObNgwWRF/PB3uS5qSbINsZm2vQYrYD
# QlcEMc9Xe0iKatefGLFer2FBcakdzNYGp7FAb0/55D1gRRgQ/6qeCek9ttrUHbwv
# bT7/I3IUWCVNPjIbIKvN7tB8ul4/mCRGmQuDQPWbAkz/wk7XIvM0SQKcdjZHmAls
# Al+upDzrifeWC5IsRLpye5PsNd2IGoNn8ZS++xnKNijsUp6Hc1pi6MafFErEctOn
# Y2HrDpMml6bygQabekAvf2FxyB9RrZn7kvfVBzUSzt8i7nlrDoT+XMXOwTWYebHc
