...
.PARAMETER Legacy
    The Microsoft Software Key Storage Provider is used by default. Using this parameter will for the use of the legacy Microsoft Base Cryptographic Provider instead of the Microsoft Software Key Storage Provider. This is required for compatibility with some older platforms that do not support Cryptography API: Next Generation (CNG).
...
.EXAMPLE
    New-CSR -Hostname vpn.example.net -Online -TemplateName VpnServers -Legacy

    Generates a CSR with the public hostname vpn.example.net and submits the CSR to an online enterprise issuing CA using the certificate template named VpnServers and the legacy Microsoft Base Cryptographic Provider.
...
Function New-Csr {
    ...
    # Warn user if Legacy switch is used with EC
    If ($Legacy -and $EC) {

        Write-Warning 'The Legacy switch is not compatible with EC keys.'
        Return
    ...
    If ($Legacy) {
        ...
        Write-Verbose 'Using legacy Microsoft Base Cryptographic Provider...'
        [void]$Inf.Add('ProviderName = "Microsoft Base Cryptographic Provider v1.0"')

    }

    Else {

        Write-Verbose 'Using Microsoft Software Key Storage Provider...'
        [void]$Inf.Add('ProviderName = "Microsoft Software Key Storage Provider"')
    ...
    Else {
        ...
        [void]( & certreq.exe -new $InfPath $CsrPath )
    ...
    If ($Online) {
        ...
        [void]( & certreq.exe -submit -attrib "CertificateTemplate:$TemplateName" $CsrPath $CerPath )

        If (Test-Path $CerPath) {

            # Import certificate
            Write-Verbose 'Certificate issued successfully. Importing certificate...'
            [void]( Import-Certificate -FilePath $CerPath -CertStoreLocation Cert:\LocalMachine\My )
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBlWIVoTcKSHSHp
# 7subJGVTfnEmtgBaqaqbGTr8gtrBpqCCGpkwggNZMIIC36ADAgECAhAPuKdAuRWN
...
# DAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgZLLnKxM9ylBySPOC4GuKKOr1
# bk6zSzZ1HRFwILDsl9YwCwYHKoZIzj0CAQUABEcwRQIhAOOeKRMhGBrv0CDD82dM
# GarxxPIFIX/d4N9dhu1YTEX6AiBSPtaVyKHsZjs5BPEkEtiyPvKmabhZ5XZd2Yft
# Lgb+3aGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkxCzAJBgNVBAYT
# AlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4RGlnaUNlcnQg
# VHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYgMjAyNSBDQTEC
# EAqA7xhLjfEFgtHEdqeVdGgwDQYJYIZIAWUDBAIBBQCgaTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjAzMTYyMzQ1NDlaMC8GCSqG
# SIb3DQEJBDEiBCC4U+3Hlu0KUbjmVSn/fX0kdYxPLLph03ngJX7TX0R3SjANBgkq
# hkiG9w0BAQEFAASCAgCYZA0fuXIKYh0NNfTEZVcATVHg6RddBTfztZcQmoPc2cDh
# 3i1M8Kcxwzw1RHR876KBCGHcT9r1J29/Ner8UPzKHzYNLWifj46jnVGtpB1pqxm8
# J0QGUZL4uGs3slVpj+RZpxsrc5nkE5PRqf13exmaLdYMnYg0i/oJ5wPpPeSz9F4s
# 7te5jPMYYKhg/sf4nZxu/N/OXjdjMjOplawJWh3MHSlfRcWRSHFB9Vh6ghT1wX6U
# KjNzc+EGi92o7jS4wi23RuiKzmr8Ex2L+dwSZ8ltkTEL43O77HbT42Myco7ZcIdI
# Nny+Zerhu8bDmVWpS2vUGfvEfrZy5cM59yKksMZAUeohUhMw2wr7Zpj56Uu2YzCW
# D3DPy2ONl0PSB5mB5oi+rqsP0w+Ffdu7M3b3O260cjEYjF0IByH+WzTt9JC+OKEw
# fW0j/VsuLToqD7rofp9oyE1+F7mBYpyBTDO4sFzITbg9c+1ulEs3DCLkXzUJk3GQ
# KV+lJIPGcPqtdVcVs8Uw67YGA5nkfX3N36x/Xl9dB9vIhQ5Y9wd1gIF6EQNu5Pj9
# QAyrHesnzB7qWFAgq0JXdNz3E7vXGX8FKuwWyxREoFfux/hw+5X2MRAujy2JuqBN
# WcHGzR1F5gjv5fD75C15Z9XJW0VuC10K0iMoSfv6tyYAMuprKZDLCqEMclR6Qw==
